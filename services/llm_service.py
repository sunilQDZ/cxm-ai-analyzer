...
3. Recommendation MUST be organization-facing and action-oriented. Vary your phrasing naturally using direct active operational verbs (e.g., "Streamline...", "Investigate...", "Optimize...", "Enhance...", "Establish...", "Update...", "Train...", "Resolve..."). DO NOT repeat generic prefixes like "The organization should..." or "Acknowledge..." across multiple items. NEVER use customer-facing responses like "Thank you for your feedback".
...
5. POSITIVE FEEDBACK RULE: For positive customer feedback, DO NOT write "No specific recommendations needed". Provide an operational recommendation (e.g., "Maintain high service standards and commend the team for excellent performance.").
6. LENGTH PROPORTIONALITY RULE: Scale the length and detail of both "observation" and "recommendations" proportionally to the customer comment's length and depth. For short comments (1 sentence), provide a concise single-sentence summary and recommendation. For longer or multi-part comments, provide a detailed 2-3 sentence analysis covering all reported aspects.
